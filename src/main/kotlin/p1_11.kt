...
fun main() {
    val firstMatrix = Matrix(arrayOf(intArrayOf(2, 0, 4), intArrayOf(1,6,9)))
    val secondMatrix = Matrix(arrayOf(intArrayOf(3, -6), intArrayOf(5, 1), intArrayOf(2,9)))
    val secondMatrix1 = Matrix(arrayOf(intArrayOf(0, 7), intArrayOf(3,7), intArrayOf(6,7)))
